...
public class Edit_Screen extends JFrame {
	...
	ControllerEdit controllerEdit = new ControllerEdit(this);
	ControllerEdit controllerEdit2 = new ControllerEdit(this);
	...
	public JPanel pn_Btn() {
		...
		btn_Back.addActionListener(controllerEdit);
		btn_Done = new JButton("DONE", new ImageIcon("src/Image/Icon/Finish.png"));
		btn_Done.addActionListener(controllerEdit2);
		// Them tung thanh phan vao panel
		pn_Btn.add(btn_Back);
		pn_Btn.add(btn_Done);
		pn_South.add(pn_Btn);
	...
	public JPanel pn_Main() {
		...
		pn_Main.add(pn_Info());
		pn_Main.add(pn_Btn());
		// pn_Main.setLayout(new FlowLayout());
